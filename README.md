...
* OrionDoS - Скрипт DDoS-атаки с множеством методов
* Присутствуют Bypass Методы
...
<h1>Дисклеймер!!!</h1>
<br>
* Автор репозитория не несет ответственность за использование данного ресурса третьими лицами
* Весь материал опубликован сугубо в ознакомительных ценях
 ...
 * 💣 L7 (По Домену)
   ...
   * <img src="https://img.icons8.com/cotton/344/domain.png" width="16" height="16" alt="get"> GET | GET Спам
   * <img src="https://cdn0.iconfinder.com/data/icons/database-storage-5/60/server__database__fire__burn__safety-512.png" width="16" height="16" alt="post"> POST | POST Спам
   ...
   * <img src="https://cdn.iconscout.com/icon/premium/png-256-thumb/cyber-bullying-2557797-2152371.png" width="16" height="16" alt="stress"> STRESS | Отправить HTTP-пакет с большим байтом
   * <img src="https://pbs.twimg.com/profile_images/1351562987224641544/IKb4q_yd_400x400.jpg" width="16" height="16" alt="dyn"> DYN | Новый метод со случайным поддоменом
   * <img src="https://cdn-icons-png.flaticon.com/512/6991/6991643.png" width="16" height="16" alt="downloader"> DOWNLOADER | Новый метод медленного чтения данных
   * <img src="https://cdn2.iconfinder.com/data/icons/poison-and-venom-fill/160/loris2-512.png" width="16" height="16" alt="slow"> SLOW | Старый метод DDoS Slowloris
...
`
  * 🌟 CFIP | Найдите реальный IP-адрес веб-сайтов, работающих на Cloudflare
  * 🔪 DNS | Показать DNS-записи сайтов
  * 📍  TSSRV | TeamSpeak SRV Resolver
  * ⚠  PING | ПИНГ Сервера
  * 📌 CHECK | Проверить статус веб-сайта
  * 😎 DSTAT | Показывает полученные байты, отправленные байты и их количество

* 🎩 Other
  * ❌ STOP | Остановить все атаки
  * 🌠 TOOLS | Инструменты консоли
  * 👑 HELP | Показать скрипты использования


<h1>Использование</h1>
<br>
<p>git clone https://github.com/MatrixTM/MHDDoS.git</p>
<p>cd MHDDoS</p>
<p>sudo pip3 install -r requirements.txt<p>
<p> L7 Атака (по домену): python3 client.py <метод> <url> <socks_type> <кол-во потоков> <proxylist> <rpc> <время> <debug=optional></p>
<p>L4 Атака (по IP): python3 client.py <метод> <ip:port> <кол-во потоков> <время></p>
